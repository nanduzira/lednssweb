...
<?php
      ...
      echo "<table align='center' width='70%' border='1'> 
       <tr><td >Ward</td><td >".$row1['ward_no']."</td></tr>
        <tr><td >House No</td><td >".$row1['house_no']."</td></tr>
      <tr><td >Age</td><td >".$row1['age']."</td></tr>
      <tr><td >Sex</td><td >".$row1['sex']."</td></tr>
      <tr><td >Educational Qualification</td><td >".$row1['edu_quali']."</td></tr>
      <tr><td >Job</td><td >".$row1['job']."</td></tr>
      <tr><td >Aadhar No</td><td >".$row1['adhaar']."</td></tr>
      <tr><td >Election ID</td><td >".$row1['elec_id']."</td></tr>
      <tr><td >Govt Aids Received</td><td >".$row1['govt_aid']."</td></tr>
      <tr><td >Traits or Specialities</td><td >".$row1['trait_speciality']."</td></tr></table>";
	  }
